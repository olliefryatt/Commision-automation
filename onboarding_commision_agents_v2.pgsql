...
-- Note set up like this for historic reasons, should really just group by month
...
------- End of script for commission calcs ----- 


-- Now table just to show us raw data
select
    agent_onboard_month_for_commissions,
    ...
    "nationalId",
    uuid_agent, uuid_aba 
    --"asaUuid" as uuid_aba_db,
    --"onboardedAsaUuid" as uuid_aba_onboarding
from df_4
