...
calc_dates_1 (calc_for_month, date_time) AS (
    values
    ('December',  date_trunc('day','2022-12-27T00:00:00.000Z'::date)),
    ('November',  date_trunc('day','2022-11-27T00:00:00.000Z'::date)),
    ('October',   date_trunc('day','2022-10-27T00:00:00.000Z'::date)),
    ('September', date_trunc('day','2022-09-27T00:00:00.000Z'::date)),
    ('August',    date_trunc('day','2022-08-27T00:00:00.000Z'::date)),
